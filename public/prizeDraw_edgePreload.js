...
if(document.addEventListener ){ 
   ...
   aLoader = [
      ...
      { load: "js/greensock/uncompressed/TweenMax.js", user: true },
      { load: "js/greensock/uncompressed/utils/Draggable.js", user: true },
      { load: "prizeDraw_edge.js"},
      { load: "prizeDraw_edgeActions.js"}];
...
var plSTF="width",ctrPlS="horizontal",minPlW="0",maxPlW="1024px",plWidth="1024px",plHeight="768px";
...
preContent={
    dom: [
    {
        ...
        type: 'image',
        tag: 'img',
        rect: ['480px', '360px','64px','48px','auto', 'auto'],
        fill: ["rgba(0,0,0,0)",'images/fruit_machine.gif','0px','0px']
    }]};//simpleContent
